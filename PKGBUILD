...
pkgname=wine-lol-git
pkgver=4.14-130-gf238e846e7_stage
pkgrel=1
...
source=('git://source.winehq.org/git/wine.git'
        ...
        'wine-binfmt.conf'
        'wine-lol-diff64496::https://bugs.winehq.org/attachment.cgi?id=64496'
        'wine-lol-diff64507::https://bugs.winehq.org/attachment.cgi?id=64507')
sha256sums=('SKIP'
            'SKIP'
            '9901a5ee619f24662b241672a7358364617227937d5f6d3126f70528ee5111e7'
            '6dfdefec305024ca11f35ad7536565f5551f09119dda2028f194aee8f77077a4'
            '25669dcd96297de95500651e4ef0a5fe3716a4ec85f36a52d6d26e4dc1ae3462'
            '1da94afb4f3a774fb1e978e67a4527bb8400c31e98fa76e3fd42d913e69899af')
...
prepare() {
    ...
    pushd "${srcdir}/wine-staging/patches"
    ./patchinstall.sh DESTDIR="${srcdir}/wine" --all
    popd
    
    # Apply League Of Legends fixes
    pushd ${srcdir}/wine
    patch -p1 -i "$srcdir/wine-lol-diff64496"
    patch -p1 -i "$srcdir/wine-lol-diff64507"
    popd
